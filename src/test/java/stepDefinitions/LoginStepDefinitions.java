...
public class LoginStepDefinitions {
    ...
    public void iEnterNotExistingEmail(String arg0) {
        LoginPage loginPage = new LoginPage(driver);
        loginPage.provideEmail("i@testpro.io");
        Assert.assertFalse(loginPage.getLogo().isDisplayed());
    }


    @When("I enter  empty email and password {string},{string}")
    public void iEnterEmptyEmailAndPassword(String arg0, String arg1) {
        LoginPage loginPage = new LoginPage(driver);
